...
public class DeviceInfoSettings extends RestrictedSettingsFragment {
    ...
    private static final String KEY_FUSION_VERSION = "fusion_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_FUSION_VERSION, "ro.fusion.version");
        findPreference(KEY_FUSION_VERSION).setEnabled(true);
